        ...
        <div className="task-detail-content">
          ...
          <div className="task-head-info">
            <div className="task-head-left">
              ...
              <div className="task-tags">
                ...
                <span className="task-tag">
                  {translate("City Zero", "City Zero")}
                </span>
                <span className="task-tag">
                  {translate("链上身份", "On-Chain Identity")}
                </span>
                <span className="task-tag">
                  {translate("治理", "Governance")}
                </span>
              </div>
            </div>
            <div className="task-head-right">
              ...
              >
                {translate("项目白皮书", "Project Whitepaper")}
              </a>
            </div>
          </div>
          ...
          <div className="task-body-layout">
            ...
            <div className="task-main-content">
              <h4 className="task-section-title">
                {translate("项目详情", "Event Detail Description")}
              </h4>
